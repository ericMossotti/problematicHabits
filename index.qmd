...
SELECT
  ...
  ,AVG(min_q1) AS 'Q1(12am_6am)'
  ,AVG(q1_q2) AS 'Q2(6am_12pm)'
  ,AVG(q2_q3) AS 'Q3(12pm_6pm)'
  ,AVG(q3_max) AS 'Q4(6pm_12am)'
FROM 
  AggregatedLights al
GROUP BY 
  useHrs;""").df()
...
r_plot <- ggplot(data = r_df, 
  ...
  labs(title = 'Risk Categories', 
       ...
       y = "Problematic Behavior Index (sii)")   #guide_legend(title = "sii (avg)")
 # coord_flip()
...
SELECT 
  ...
  ,AVG(min_q1) AS 'Q1_12am_6am'
  ,AVG(q1_q2) AS 'Q2_6am_12pm'
  ,AVG(q2_q3) AS 'Q3_12pm_6pm'
  ,AVG(q3_max) AS 'Q4_6pm_12am'
FROM 
...
data_long <- r_df |>
  pivot_longer(
    cols = c(Q1_12am_6am, Q2_6am_12pm, Q3_12pm_6pm, Q4_6pm_12am),
    names_to = "quarter",
    values_to = "lux"
  ) |>
  mutate(quarter = factor(quarter, 
                          levels = c("Q1_12am_6am",
                                     "Q2_6am_12pm",
                                     "Q3_12pm_6pm",
                                     "Q4_6pm_12am")))
