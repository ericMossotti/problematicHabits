...
def cross_validate(
  ...
  # Save the training data (features + target) for visualization
  train_data = pd.concat(
    [X, pd.DataFrame({target_col: y})], axis = 1)
    
  train_data.to_csv(
    "data/output/train_data.csv", index = False)
...
def evaluate_test_data(
  ...
  df.to_csv(
    "data/output/test_results.csv", index = False)
...
# Save the model
save_model(final_model, lgb_params, path = "data/output/lightGbm")

# Evaluate on test data and save test results
