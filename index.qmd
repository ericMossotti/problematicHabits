...
I noticed that using ENUM data types significantly sped up certain database operations. [@holanda_duckdb_2021]
...
def try_create(conn, type_str: str, enum_str: str) -> pd.Series:
  ...
  try:
    ...
    return pd.Series(type_str, index = ['already exists'])
